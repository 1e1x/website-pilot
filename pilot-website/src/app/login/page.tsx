    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
          ...
          <CardHeader className="text-center pb-2">
            <div className="mx-auto mb-4">
              <div className="w-16 h-16 bg-black rounded-2xl flex items-center justify-center mb-4">
                <span className="text-white font-bold text-xl">1e1x</span>
              </div>
            </div>
            <CardTitle className="text-2xl font-bold text-gray-900">Welcome Back! 🚀</CardTitle>
            <p className="text-gray-600 mt-2">Sign in to continue your innovation journey</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-11 border-gray-300 focus:border-black focus:ring-black pr-10"
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-11 bg-black hover:bg-gray-800 text-white font-medium transition-all duration-200 hover:shadow-lg"
              >
                {isLoading ? (
                  <div className="flex items-center">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">🚀 Join 500+ innovators building the future in Qatar</p>
        </div>
      </div>
    </div>
  )
